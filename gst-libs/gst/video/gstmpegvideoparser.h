...
typedef struct _GstMpegVideoSequenceExtension GstMpegVideoSequenceExtension;
 ...
 **/
struct _GstMpegVideoSequenceExtension
{
...
gboolean gst_mpeg_video_parse_gop                (GstMpegVideoGop * gop,
    guint8 * data, gsize size, guint offset);
gboolean gst_mpeg_video_parse_sequence_extension (GstMpegVideoSequenceExtension * seqext,
    guint8 * data, gsize size, guint offset);
